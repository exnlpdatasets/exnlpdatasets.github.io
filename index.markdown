...
This website collects datasets for Explainable NLP (ExNLP). It started with the paper :sparkles: [Teach Me to Explain: A Review of Datasets for Explainable NLP](https://arxiv.org/abs/2102.12060) :sparkles:, and we hope it will evolve as new datasets are collected.
